...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Truhub website revamp enhances the existing Truhub Solutions website." },
      { property: "og:description", content: "Truhub website revamp enhances the existing Truhub Solutions website." },
      { name: "twitter:description", content: "Truhub website revamp enhances the existing Truhub Solutions website." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/4741754f-6cd7-478f-8468-46d443a54ecb/id-preview-67ed3a4c--c0d24e28-0152-4ba7-9709-40bf2025e14f.lovable.app-1783235938755.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/4741754f-6cd7-478f-8468-46d443a54ecb/id-preview-67ed3a4c--c0d24e28-0152-4ba7-9709-40bf2025e14f.lovable.app-1783235938755.png" },
    ],
    links: [
